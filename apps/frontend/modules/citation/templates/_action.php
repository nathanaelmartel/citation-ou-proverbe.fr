  ...
  <a class="pinterest-share icon" title="partager sur pinterest" target="_blank" href="https://pinterest.com/pin/create/button/?url=<?php echo $url.'?pk_campaign=share&pk_kwd=share-pinterest' ?>&amp;media=<?php echo $image ?>&amp;description=<?php echo $citation->quote ?>">&nbsp;</a>
	<a class="note <?php echo ($sf_user->getAttribute('note_'.$citation->id))?'actioned':'';?>" title="J'aime cette citation" data-citation="<?php echo $citation->id ?>"><span>&nbsp;</span><span><?php echo $citation->note ?></span></a>
